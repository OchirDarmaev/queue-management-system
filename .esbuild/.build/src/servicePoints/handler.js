...
// src/servicePoints/handler.ts
var handler_exports = {};
__export(handler_exports, {
  createServicePoint: () => createServicePoint,
  deleteServicePoint: () => deleteServicePoint,
  getAllServicePoints: () => getAllServicePoints
});
...
var createServicePoint = async (event) => {
...
var deleteServicePoint = async (event) => {
...
var getAllServicePoints = async (event) => {
  const params = {
    TableName: process.env.SERVICE_POINTS_TABLE
  };
